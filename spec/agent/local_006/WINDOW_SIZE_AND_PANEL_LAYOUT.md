...
> **関連ドキュメント**: `spec\gui\rearchitecture\IMPLEMENTATION_PLAN.md`, `spec\gui\rearchitecture\PHASE_3_PREVIEW_AND_OBSERVABILITY.md`, `spec\gui\WINDOW_SIZE_PRESETS.md`, `spec\gui\MACRO_EXPLORER_PANEL.md`, `spec\gui\PREVIEW_AND_LOG_LAYOUT.md`, `spec\gui\LAYOUT_IMPLEMENTATION_PLAN.md`
