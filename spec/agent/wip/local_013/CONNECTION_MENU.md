...
| ファイル | 変更種別 | 変更内容 |
|----------|----------|----------|
| `src/nyxpy/gui/main_window.py` | 変更 | `File` menu を廃止し、`connection_menu.py` へ menu 構築を委譲する。Settings action はメニューバーへ追加しない。 |
