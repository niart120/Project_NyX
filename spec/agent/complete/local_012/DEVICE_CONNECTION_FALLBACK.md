...
> **関連ドキュメント**: `spec/framework/archive/hardware_design.md`, `spec/framework/archive/protocol_design.md`, `spec/agent/complete/local_013/CONNECTION_MENU.md`
...
- GUI 接続メニューの構造は `spec/agent/complete/local_013/CONNECTION_MENU.md` で扱う。
