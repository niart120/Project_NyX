...
.venv-testpypi\Scripts\python -m pip download --no-deps --index-url https://test.pypi.org/simple/ --dest .tmp-testpypi nyxpy-fw==0.3.0
.venv-testpypi\Scripts\python -m pip install .tmp-testpypi\nyxpy_fw-0.3.0-py3-none-any.whl
