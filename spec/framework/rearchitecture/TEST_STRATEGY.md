...
class FakeControllerOutputPort:
    sent: list[tuple[str, tuple[KeyInput, ...]]] = field(default_factory=list)

    def press(self, keys: tuple[KeyInput, ...]) -> None: ...
    def hold(self, keys: tuple[KeyInput, ...]) -> None: ...
    def release(self, keys: tuple[KeyInput, ...] = ()) -> None: ...
    def keyboard(self, text: str) -> None: ...
    def type_key(self, key: KeyInput) -> None: ...
    def close(self) -> None: ...
...
| ユニット | `test_default_command_rejects_legacy_constructor_args` | 旧具象引数が `RuntimeConfigurationError` になる |
