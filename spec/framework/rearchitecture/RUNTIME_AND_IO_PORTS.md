...
> **関連ドキュメント**: `.github\skills\framework-spec-writing\template.md`, `CONFIGURATION_AND_RESOURCES.md`, `RESOURCE_FILE_IO.md`, `LOGGING_FRAMEWORK.md`, `ERROR_CANCELLATION_LOGGING.md`, `OBSERVABILITY_AND_GUI_CLI.md`, `TEST_STRATEGY.md`
...
| `log_manager` / `LogManager` | 廃止。`LoggerPort`、`LogBackend`、`LogSinkDispatcher`、`LogSanitizer` へ分解する | shim が残る間だけ sink 登録と handler snapshot を解除する |
