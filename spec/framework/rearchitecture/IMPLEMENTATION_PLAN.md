...
| 3 | lifecycle order、`finalize` guarantee、`RunResult`、`MacroStopException` compatibility、`safe_point_latency` |
...
| 6.1 | resource scope、run artifact store、static 互換削除、atomic write、path guard |
