...
#### **解放 (release)**
1. `btn1` フィールドから対象ボタンの **下位バイト** をクリア（AND NOT 演算）
2. `btn2` フィールドから対象ボタンの **上位バイト** をクリア（AND NOT 演算）
