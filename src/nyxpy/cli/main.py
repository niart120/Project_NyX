...
def create_hardware_components(serial_port: str, capture_device: str) -> HardwareFacade:
    ...
    if serial_port not in available_serial_devices:
        ...
        raise ValueError(f"Serial port '{serial_port}' not found. Available devices: {available_devices_str}")
    ...
    if capture_device not in available_capture_devices:
        ...
        raise ValueError(f"Capture device '{capture_device}' not found. Available devices: {available_devices_str}")
