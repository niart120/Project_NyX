...
_BASE_RECTS: dict[str, _WidgetRect] = {
    ...
    "btn_x": _WidgetRect(196, 82, 28, 28),
    "btn_y": _WidgetRect(166, 112, 28, 28),
    "btn_a": _WidgetRect(226, 112, 28, 28),
    "btn_b": _WidgetRect(196, 142, 28, 28),
    "left_stick": _WidgetRect(18, 150, 64, 64),
    "btn_ls": _WidgetRect(35, 214, 30, 20),
    "dpad": _WidgetRect(92, 152, 72, 72),
    "right_stick": _WidgetRect(202, 158, 64, 64),
    "btn_rs": _WidgetRect(219, 220, 30, 20),
}
