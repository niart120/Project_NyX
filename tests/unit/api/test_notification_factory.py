...
def test_create_notification_handler_from_settings():
    # Discordのみ
    s = DummySettings(
        {"notification.discord.enabled": True, "notification.discord.webhook_url": "url1"}
    )
    ...
    s = DummySettings(
        {
            "notification.bluesky.enabled": True,
            "notification.bluesky.identifier": "id1",
            "notification.bluesky.password": "pass1",
        }
    )
    handler = create_notification_handler_from_settings(s)
